...
var priceCounter = document.querySelectorAll(".priceCounter");

function updateCart(foods) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/update-cart", foods).then(function (res) {
...
addCart.forEach(function (btn) {
  btn.addEventListener("click", function (effect) {
    var foods = JSON.parse(btn.dataset.food);
    updateCart(foods);
  });
...
var socket = io();
Object(_admin__WEBPACK_IMPORTED_MODULE_2__["initAdmin"])(socket); //passing parameter
//join 
...
var adminAreaPath = window.location.pathname; // verying admin page.
...
socket.on('orderUpdated', function (data) {
  //listening the data from server
...
__webpack_require__(/*! C:\Users\sammygrg\Desktop\food-tracker\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\sammygrg\Desktop\food-tracker\resources\scss\app.scss */"./resources/scss/app.scss");
